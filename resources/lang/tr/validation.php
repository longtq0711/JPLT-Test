...
return [
    ...
    */
    ...
    'accepted' => ':attribute 受け入れる必要があります。',
    'active_url' => ':attribute 有効な URL である必要があります。',
    'after' => ':attribute の値は、:date より後である必要があります。',
    'after_or_equal' => ':attribute 値は、:date 以降でなければなりません。',
    'alpha' => ':attribute には文字のみを含める必要があります。',
    'alpha_dash' => ':attribute には、文字、数字、およびダッシュのみを含める必要があります.',
    ...
    'timezone' => ':attribute 有効なタイムゾーンでなければなりません。',
    'unique' => ':attribute 以前に登録された。',
    'uploaded' => ':attribute インストールに失敗しました。',
    'url' => ':attribute フォーマットが無効です。',
    'uuid' => ':attribute UUID 形式に準拠する必要があります。',
