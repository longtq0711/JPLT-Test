...
/***/ "./app/Modules/Admin/Resources/js/crontabs/category.js":
/*!*************************************************************!*\
  !*** ./app/Modules/Admin/Resources/js/crontabs/category.js ***!
  \*************************************************************/
/*! no exports provided */
...
if ($("#crontab_category").length) {
  new Vue({
    ...
    created: function created() {
      ...
      this.crontabSites = JSON.parse($('#crontabSites').val());
      this.getItems(this.pagination.current_page);
      this.treeCategories = this.categoryToTree(this.categories);
      this.treeCrontabCategories = this.categoryToTree(this.categories, false, false);
    },
    methods: {
      getItems: function getItems(page) {
        ...
        axios.get('/admin/crontab-categories/get-data', {
          params: scop.search
      ...
      deleteItem: function deleteItem(item) {
        ...
        Swal.fire({
          ...
          if (result.value) {
            axios["delete"]('/admin/crontab-categories/delete/' + item.id).then(function (response) {
      ...
      updateItem: function updateItem(item) {
        axios.put('/admin/crontab-categories/update/' + item.id, {
...
/***/ 14:
/*!*******************************************************************!*\
  !*** multi ./app/Modules/Admin/Resources/js/crontabs/category.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\Laginza\mua_ho\app\Modules\Admin\Resources\js\crontabs\category.js */"./app/Modules/Admin/Resources/js/crontabs/category.js");
